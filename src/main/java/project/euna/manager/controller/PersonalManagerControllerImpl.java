...
import project.euna.manager.service.PersonalManagerService;
...
public class PersonalManagerControllerImpl implements PersonalManagerController {
	@Autowired 
	PersonalManagerService managerService;
	
	@Override
	@RequestMapping(value = "/main", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView searchInit(HttpServletRequest request, HttpServletResponse response) throws Exception {
		request.setCharacterEncoding("utf-8");
		ModelAndView mav = new ModelAndView("/manager/personalinfo");
		return mav;
	} 
	...
	public Map searchList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		searchMap.put("p_i_Content", request.getParameter("p_i_Content"));
