									...
									<div class="row">
										<div class="col-sm-6">
											<img class="img-fluid mb-3"
												src="../resources/dist/img/photo2.png" alt="Photo"> <img
												class="img-fluid" src="../resources/dist/img/photo3.jpg"
												alt="Photo">
										</div>
										<!-- /.col -->
										<div class="col-sm-6">
											<img class="img-fluid mb-3"
												src="../resources/dist/img/photo4.jpg" alt="Photo"> <img
												class="img-fluid" src="../resources/dist/img/photo1.png"
												alt="Photo">
										</div>
										<!-- /.col -->
									</div>
