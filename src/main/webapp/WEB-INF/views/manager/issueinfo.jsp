...
<script language="javascript">
	...
	function LoadPage() {
		...
		initSheet.Cols = [
			...
			{Header:"협업공간ID",Type:"Text",SaveName:"c_Id",MinWidth:50 ,MultiLineText:1,Edit:false},
			{Header:"협업공간명",Type:"Text",SaveName:"c_Name",MinWidth:100 ,MultiLineText:1,Edit:false},			
			{Header:"작성일",Type:"Date",SaveName:"i_Date",MinWidth:100,Edit:false},
...
<body onload="LoadPage()">
  ...
  <div class="main_content">
    ...
    <div class="exp_product" style="width: 100%;">
      <form name='frm'>
        작성자ID: <input type='text' id="mem_Id" name="mem_Id" /> 
          제목: <input type='text' id="i_Name" name="i_Name" /> 
       협업공간명: <input type='text' id="c_Name" name="c_Name" /> 
         내용: <input type='text' id="i_Content" name="i_Content" />
      </form>
    </div>
