		...
		<aside class="main-sidebar elevation-4 sidebar-dark-danger">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item"><a
							href="../resources/pages/widgets.html" class="nav-link"> <i
						...
						<li class="nav-item has-treeview"><a href="#"
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a
									href="../resources/pages/UI/modals.html" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Modals & Alerts</p>
								</a></li>
								<li class="nav-item"><a
									href="../resources/pages/UI/navbar.html" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Navbar & Tabs</p>
								</a></li>
								<li class="nav-item"><a
						...
						<li class="nav-item has-treeview"><a href="#"
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a
									href="../resources/pages/forms/validation.html"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Validation</p>
								</a></li>
							</ul></li>
						...
						<li class="nav-item"><a
							href="../resources/pages/gallery.html" class="nav-link"> <i
						...
						<li class="nav-item has-treeview"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="../resources/pages/examples/invoice.html"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Invoice</p>
								</a></li>
								<li class="nav-item"><a
									href="../resources/pages/examples/profile.html"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Profile</p>
								</a></li>
								<li class="nav-item"><a
