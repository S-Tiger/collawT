          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <label for="inputSpentBudget">이름</label>
              ...
              <div class="form-group">
                ...
                <input type="hidden" id="inputEstimatedDuration" class="form-control">
              </div>
              <div class="row">
       			 <div class="col-12">
            ...
            <!-- 이미지 나오는  -->
              ...
              <div class="row">
       			 <div class="col-12"style="padding: 5px;">
         		 	<input type="submit" value="프로필 사진 변경" class="btn btn-success float-right">
        			</form>
        		</div>
      		  </div>
            </div>
        ...
        <div class="col-md-6">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputSpentBudget">새로운 비밀번호</label>
                <input class="form-control" id="pw"	name="mem_Pwd" type="password" required>
              </div>
              <div class="form-group">
                <label for="inputEstimatedDuration">새로운 비밀번호 확인</label>
              <input class="form-control" id="pw2" type="password" type="password" required>
              </div>
              <div class="row">
       			 <div class="col-12">
         		 	<input type="submit" value="비밀번호 변경" class="btn btn-success float-right">
        		</div>
      		  </div>
      		  </form>
            </div>
